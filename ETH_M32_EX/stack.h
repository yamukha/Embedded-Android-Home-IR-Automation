...
#define UDP_DISCOVER_PKT_LEN 16

extern unsigned char eth_buffer[MTU_SIZE+1];
extern unsigned int  eth_buffer_size;
extern unsigned char eth_MAC_dst[6];
extern unsigned char eth_IP_dst[4];
extern unsigned char bcast_ip[4];
extern unsigned char bcast_MAC[6];
extern unsigned char UDP_discover_pkt[UDP_DISCOVER_PKT_LEN];
//extern unsigned char UDP_pkt_len;
...
//unsigned int calc_checksum (unsigned short addr, unsigned int count)l;
...
#define UDP_OPTIONS_OFFSET 	    (UDP_DATA_START + 6)
#define UDP_DATA_LEN    	    (38)
...
// UDP discovery
#define UDP_DISCOVERY_LEN	    58
#define UDP_DISCOVERY_PAYLOAD	24   
//----------------------------------------------------------------------------
